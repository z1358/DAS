...
from robustbench.model_zoo.architectures.style_vit import style_vit_base_patch16_384 as create_model_vit_style_384
...
common_corruptions = OrderedDict([
    ...
    ('VIT_B_224_MAE', {
      'model': lambda: modify_head(create_model_mae("vit_base_patch16_224.augreg_in1k", pretrained=False)),
      'gdrive_id': '',
    }),
    ('VIT_B_224_Style', {
      'model': lambda: modify_head(create_model_vit_style("vit_base_patch16_224.augreg_in1k", pretrained=False)),
      'gdrive_id': '',
      'preprocessing': 'Res256Crop224'
    }),
    ('VIT_B_384_Style', {
      'model': lambda: modify_head(create_model_vit_style_384("vit_base_patch16_384", pretrained=False)),
      'gdrive_id': '',
      'preprocessing': 'Res256Crop224'
    }),
    ('VIT_B_224_REM', {
      'model': lambda: modify_head(create_model_vit_rem("vit_base_patch16_224.augreg_in1k", pretrained=False)),
      'gdrive_id': '',
    }),
])
