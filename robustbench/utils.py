...
def load_model(model_name: str,
    ...
    if not isinstance(models[model_name]['gdrive_id'], list):
        ...
        if any(key in model_name.lower() for key in ('mae', 'style', 'rem')):
            return model.eval()

        # if 'mae' in model_name or 'MAE' in model_name or 'Style' in model_name or 'style' in model_name or 'rem' in model_name or 'REM' in model_name:
        #     return model.eval()
